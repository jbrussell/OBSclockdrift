...
% Station Pairs
stas1 = {'WC01','EC01'}; % Stations with bad timing (to be corrected)
stas2 = {'CC04','CC04'}; % Reference stations with good timing
...
%     sta1=char(stalist(ista1,:));
    ...
    for ista2=ista1 %1:length(stas2)%nsta
